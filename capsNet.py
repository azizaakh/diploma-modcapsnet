...
"""
#Modifications: Akhmedova Azizakhon
...
class CapsNet(object):
    ...
    def build_arch(self):
        with tf.variable_scope('Conv1_layer'):
            ...
            conv1 = tf.contrib.layers.conv2d(self.X, num_outputs=32,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
            conv2 = tf.contrib.layers.conv2d(conv1, num_outputs=32,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
            conv3 = tf.contrib.layers.conv2d(conv2, num_outputs=64,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
            conv4 = tf.contrib.layers.conv2d(conv3, num_outputs=64,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
            conv5 = tf.contrib.layers.conv2d(conv4, num_outputs=128,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
            conv6 = tf.contrib.layers.conv2d(conv5, num_outputs=128,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
            conv7 = tf.contrib.layers.conv2d(conv6, num_outputs=256,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
            conv8 = tf.contrib.layers.conv2d(conv7, num_outputs=256,
                                             kernel_size=3, stride=1,
                                             padding='VALID')
        ...
        with tf.variable_scope('PrimaryCaps_layer'):
            ...
            caps1 = primaryCaps(conv8, kernel_size=9, stride=2)
